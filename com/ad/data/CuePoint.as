package com.ad.data
{
	...
	public class CuePoint extends ValueObject
	{
		...
		public function set parameters(value:Array):void{this._parameters = value;}
		
		public function get name():String{return this._name;}
		public function set name(value:String):void{this._name = value;}
		
		public function get time():String{return this._time;}
		public function set time(value:String):void{this._time = value;}
